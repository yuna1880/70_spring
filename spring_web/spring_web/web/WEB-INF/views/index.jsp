...
<head>
    ...
    <link href="/WEB-INF/css/layout.css" type="text/css" rel="stylesheet" />
    <link href="/WEB-INF/css/index.css" type="text/css" rel="stylesheet" />
    <script>
...
<header id="header">
    ...
    <div class="content-container">
        ...
        <h1 id="logo">
            <a href="/index.html">
                <img src="/WEB-INF/images/logo.png" alt="뉴렉처 온라인" />
            ...
            <div class="sub-menu">
                ...
                <nav id="member-menu" class="linear-layout">
                    ...
                    <ul class="linear-layout">
                        <li><a href="/member/home"><img src="/WEB-INF/images/txt-mypage.png" alt="마이페이지" /></a></li>
                        <li><a href="/notice/list.html"><img src="/WEB-INF/images/txt-customer.png" alt="고객센터" /></a></li>
                    </ul>
                </nav>
